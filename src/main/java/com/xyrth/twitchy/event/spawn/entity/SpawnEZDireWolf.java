...
public class SpawnEZDireWolf extends GenericEvent {

    public SpawnEZDireWolf(World world, double x, double y, double z, EntityLivingBase targetEntity) {
        super(world, x, y, z, targetEntity);
        // TODO Add EnderZoo as Dependency
        // TODO SpawnEZDireWolf
        // id of the TF mob
        int id = 206;
