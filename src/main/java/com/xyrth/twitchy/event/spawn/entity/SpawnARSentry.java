...
public class SpawnARSentry extends GenericEvent {

    public SpawnARSentry(World world, double x, double y, double z, EntityLivingBase targetEntity) {
        super(world, x, y, z, targetEntity);
        // TODO Add Dependency for Amun-Ra
        // TODO SpawnARSentry
        // id of the TF mob
        int id = 206;
